...
# RUN add-apt-repository --remove "http://apt.postgresql.org/pub/repos/apt xenial-pgdg/main"
...
CMD gunicorn --limit-request-line 32768 --timeout 360 --bind 0.0.0.0:$PORT -k gevent --worker-connections 32 app:app
